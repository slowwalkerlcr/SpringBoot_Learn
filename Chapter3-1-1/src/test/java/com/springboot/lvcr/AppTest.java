...
import com.springboot.lvcr.controller.HelloController;
import com.springboot.lvcr.controller.UserController;
...
public class AppTest {
	...
	public void testUserController() throws Exception {
		...
		// 2、post提交一个user
		request = post("/users/").param("id", "1").param("name", "测试大师")
				.param("age", "20");
		mvc.perform(request)
